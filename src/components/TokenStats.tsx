...
export default function TokenStats() {
  const totalMarketCap = tokens.reduce(
    (sum, token) => sum + token.marketCapUsd,
    0
  );
  const averagePrice =
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <div className="brutalism-card p-4 text-center">
        <h3 className="font-heading text-sm text-foreground/70 mb-1">
          Total Market Cap
        </h3>
      ...
      <div className="brutalism-card p-4 text-center">
        ...
        <p className="font-base text-sm text-foreground line-clamp-1">
          {topGainer.tokenName}
        </p>
        <p className="font-heading text-sm text-green-600">
